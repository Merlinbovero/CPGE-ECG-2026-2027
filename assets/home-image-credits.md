# Crédits des visuels de l’accueil

Visuels utilisés sur les cartes matière de la page d’accueil.

- **Maths appliquées** — Vitaly Gariev, *Hand writing mathematical formulas on a chalkboard*, Unsplash, licence Unsplash. https://unsplash.com/photos/4dXO2xAzRQk
...
Les images sont recadrées visuellement par CSS (`background-size: cover`) sans modification du fichier source distant.
